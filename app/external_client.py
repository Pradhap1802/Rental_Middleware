...
class ExternalClient:
    ...
    def ping(self) -> bool:
        try:
            r = requests.get(self.base_url, headers=self.headers, timeout=5, verify=self.cfg.verify_ssl)
    ...
    def sync_customer(self, customer_data: Dict[str, Any]) -> str:
        ...
        r = requests.post(url, json=customer_data, headers=self.headers, timeout=10, verify=self.cfg.verify_ssl)
        r.raise_for_status()
        res = r.json()
    ...
    def sync_equipment(self, equipment_data: Dict[str, Any]) -> str:
        ...
        r = requests.post(url, json=equipment_data, headers=self.headers, timeout=10, verify=self.cfg.verify_ssl)
        r.raise_for_status()
        res = r.json()
    ...
    def sync_rental_order(self, order_data: Dict[str, Any]) -> str:
        ...
        r = requests.post(url, json=order_data, headers=self.headers, timeout=10, verify=self.cfg.verify_ssl)
        r.raise_for_status()
        res = r.json()
    ...
    def sync_invoice(self, invoice_data: Dict[str, Any]) -> str:
        ...
        r = requests.post(url, json=invoice_data, headers=self.headers, timeout=10, verify=self.cfg.verify_ssl)
        r.raise_for_status()
        res = r.json()
    ...
    def sync_payment(self, payment_data: Dict[str, Any]) -> str:
        ...
        r = requests.post(url, json=payment_data, headers=self.headers, timeout=10, verify=self.cfg.verify_ssl)
        r.raise_for_status()
        res = r.json()
